...
public class CameraPictureGameLayer extends CCLayer {
	...
	public static void getBitMapfromCamera() {
		...
		MainActivity.app.startActivityForResult(Intent.createChooser(intent, "Select Picture"),1);
	}
	...
	public static CCScene scene()
	{
		...
		CCLayer layer = new CameraPictureGameLayer();
	...
	public void backCallback(Object sender) {
		...
		CCDirector.sharedDirector().replaceScene(CameraPictureGameLayer.scene());
